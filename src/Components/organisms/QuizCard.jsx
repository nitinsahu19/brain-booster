            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
                <div className="bg-white rounded-2xl shadow-lg w-full max-w-2xl p-6 space-y-6">
                    ...
                    <div className="flex justify-between">
                        <PrimaryBtn text="Previous" addClass="border border-gray-300" onClick={() => dispatch(prevQuestion())} disabled={currentIndex === 0} />

                        {currentIndex < questions.length - 1 ? (
                            <PrimaryBtn text="Next" hasBg onClick={() => dispatch(nextQuestion())}/>
                        ) : (
                            <PrimaryBtn text="Submit" hasBg onClick={handleSubmit} />
                        )}
