    ...
    <>
      <div className='grid grid-cols-1 lg:grid-cols-6 gap-6 md:gap-8 p-4 md:p-8 lg:p-12'>
        <div className='lg:col-span-3'>
          <img src={logo} alt='error' className='rounded-xl w-full h-auto object-cover' />
        </div>
        ...
        <div className='lg:col-span-3 flex flex-col gap-4 justify-center'>
          ...
          <p className='text-sm md:text-base text-gray-600'>
            Explore how artificial intelligence is revolutionizing healthcare delivery, from diagnostic tools to personalized treatment plans. Discover the latest breakthroughs and their impact on patient care.
          </p>
      ...
      <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4'>
          <div className='bg-white shadow rounded-xl p-6'>
            ...
            <div>
              <h1 className='font-bold text-2xl mt-4'>Sustainable Design Practices for Digital Products</h1>
            </div>
            ...
            <div>
              <p className='opacity-60 mt-6 text-sm'>Learn how sustainable design principles can be applied to digital products to create more environmentally conscious solutions.</p>
            </div>
          ...
          <div className='bg-white shadow rounded-xl p-6'>
            ...
            <div>
              <h1 className='font-bold text-2xl mt-4'>The Rise of Remote Work Culture</h1>
            </div>
            ...
            <div>
              <p className='opacity-60 mt-6 text-sm'>Examining the lasting impact of remote work on company culture and the future of workplace dynamics.</p>
            </div>
          ...
          <div className='bg-white shadow rounded-xl p-6'>
            ...
            <div>
              <h1 className='font-bold text-2xl mt-4'>Mindfulness in the Digital Age</h1>
            </div>
            ...
            <div>
              <p className='opacity-60 mt-6 text-sm'>Discovering ways to maintain mindfulness in our increasingly connected world and improve digital wellness.</p>
            </div>
